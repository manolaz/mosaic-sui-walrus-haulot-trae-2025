...
const _SuiStackMessagingClient = class _SuiStackMessagingClient {
  ...
  createChannelFlow({
    ...
    const build = () => {
      ...
      const config = tx.add((0, import_config.none)());
      const [channel, creatorCap, creatorMemberCap] = tx.add((0, import_channel._new)({ arguments: { config } }));
      ...
      tx.add((0, import_channel.share)({ arguments: { self: channel, creatorCap } }));
      tx.add(
      ...
      tx.add((0, import_creator_cap.transferToSender)({ arguments: { self: creatorCap } }));
      return tx;
    };
